...
function ProfileMenu() {
  ...
  const userAvatar  = user?.avatar; // Get avatar from auth context
  ...
  return (
    <div className="profile-menu-container">
      ...
      >
        {userAvatar ? (
          <img src={userAvatar} alt="Profile" className="pm-btn-img" />
        ) : (
          userInitial
        )}
      </button>
        ...
        <div ref={menuRef} className="pm-dropdown">
          ...
          <div className="pm-header">
            <div className={`pm-avatar-lg ${userAvatar ? 'has-img' : ''}`}>
              {userAvatar ? (
                <img src={userAvatar} alt="Profile" className="pm-header-img" />
              ) : (
                userInitial
              )}
            </div>
